...
def actualizar_registro(
    ...
    """
    Actualiza un registro existente en la base de datos utilizando el procedimiento dbo.AntoUpdate_Proveedores.
    """
    ...
    try:
        ...
        # Imprimir valores enviados
        print("Valores enviados al procedimiento almacenado:")
        print(f"CUIL: {cuil}, RAZON_SOCIAL: {razon_social}")
        print(f"FECHA_ULT_LIB_DEUDA: {fecha_ult_lib_deuda}, DNI_DESDE_CUIT: {dni_desde_cuit}")
        ...
        if cursor.rowcount > 0:
            ...
            print("No se actualizaron registros. Verifica los datos proporcionados.")
        return True
